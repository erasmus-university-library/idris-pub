...
class IBlobStoreBackend(Interface):
    ...
    def write_transform_data(self, blob_key, transform_id, data, content_type):
        """Write bytes to storage generated by a specific transform
        the data can be read back with the read_transform_data method
        """
        pass

    def read_transform_data(self, blob_key, transform_id):
        """Read bytes from storage generated by a specific transform
        returns bytes
        """
        pass
...
class IBlobTransform(Interface):
    ...
    blob = Attribute('The blob resource')
    backend = Attribute('The blobstore backend')
